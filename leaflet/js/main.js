...
$(document).ready(function () {
  /********** File Path **********/
  stateJSON =
    "https://yijingzhou33.github.io/BTAA_County_Map/leaflet/json/activeStates.topo.json";
  countyJSON =
    "https://yijingzhou33.github.io/BTAA_County_Map/leaflet/json/activeCounties.topo.json";
  cityJSON =
    "https://yijingzhou33.github.io/BTAA_County_Map/leaflet/json/activeCities.json";
  legendJSON =
    "https://yijingzhou33.github.io/BTAA_County_Map/leaflet/json/legend.json";
    ...
    success: function (data) {
      ...
      legendPanel.onAdd = function () {
        var div = L.DomUtil.create("div", "info legend p-3"),
          ...
          label = [
            '<h6 style="font-family: Josefin Sans, sans-serif;">Number of Records</h6><p class="mb-1">County-hosted Data Portal</p>',
          ];
